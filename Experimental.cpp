...
void Chirp::delete_chirp(post* n)
{
  post* temporary = n;
  ...
  {
    post* second_temp = temporary;
    temporary -> previous -> next = tempory-> next;
    temporary -> previous = second_temp -> previous;
    /*
    post* forwards = n;
    post* backwards = n;
    post* node_before = forwards -> previous;
    node_before -> next = forwards -> next;

    post* node_after = backwards ->next;
